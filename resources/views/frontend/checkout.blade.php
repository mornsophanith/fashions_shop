      ...
      <div class="row">
            ...
            <form action="place-order" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-12 mb-3">
                  ...
                  <input type="text" class="form-control" id="postcode" name="post_code" value>
                </div>
                <div class="col-12 mb-3">
                ...
                <div class="col-12 mb-3">
                  <label for="state">Province <span>*</span>
                  </label>
                  <input type="text" class="form-control" id="state" name="province" value>
                </div>
                <div class="col-12 mb-3">
        ...
        <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
          <div class="order-details-confirmation">
                ...
                @if(session('cart'))
                    @foreach(session('cart') as $id => $details)
                        ...
                        <li>
                          ...
                          <span>{{ $details['quantity'] }}x - <span class="price">${{ $details['price'] }}</span></span>
                        </li>
                    @endforeach
                @endif
              <li>
                ...
                <div class="card-header" role="tab" id="headingOne">
                  <h6 class="mb-0">
                    <a data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                      <i class="bx bx-circle mr-3"></i>Paypal </a>
                  </h6>
                </div>
                ...
                <div class="card-header" role="tab" id="headingTwo">
                  <h6 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                      <i class="bx bx-circle mr-3"></i>cash on delievery </a>
                  </h6>
                </div>
                ...
                <div class="card-header" role="tab" id="headingThree">
                  <h6 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                      <i class="bx bx-circle mr-3"></i>credit card </a>
                  </h6>
                </div>
                ...
                <div class="card-header" role="tab" id="headingFour">
                  <h6 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" href="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                      <i class="bx bx-circle mr-3"></i>direct bank transfer </a>
                  </h6>
                </div>
            ...
            <a href="{{route('place_order')}}" class="btn karl-checkout-btn">Place Order</a>
          </div>
        </div>
      </div>
    </div>
