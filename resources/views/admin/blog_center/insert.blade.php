            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Form Create Blog Center</h2>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header">
                <h5>Create Blog Center</h5>
              </div>
              <div class="card-body">
                <form method ="post" class="form-group" action="/data-insert-blog_center" enctype="multipart/form-data">
                    @csrf  
