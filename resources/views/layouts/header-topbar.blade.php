                ...
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        <a
                            ...
                            aria-expanded="false"
                        >
                            <img src="{{ Auth::user()->image ? Auth::user()->image : '../assets/images/user/avatar-1.jpg' }}" alt="user-image" class="hei-40 wid-40 user-avtar" />
                        </a>
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            ...
                            <div class="dropdown-body">
                                <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                                    ...
                                    <div class="flex-shrink-0">
                                        <img src="{{ Auth::user()->image ? Auth::user()->image : '../assets/images/user/avatar-1.jpg' }}" alt="user-image" class="hei-35 user-avtar wid-35" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
